"""AGI 컬럼 정의 상수 모듈/AGI column definition constants module."""
...
WH_HANDLING_COLUMN: Final[str] = "WH_handling"
SITE_HANDLING_COLUMN: Final[str] = "Site_handling"
TOTAL_HANDLING_COLUMN: Final[str] = "Total_handling"
MINUS_COLUMN: Final[str] = "Minus"
FINAL_HANDLING_COLUMN: Final[str] = "Final_handling"
