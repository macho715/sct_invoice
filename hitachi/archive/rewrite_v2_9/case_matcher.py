...
def build_patch_plan(
    ...
    wh_col_1b: Dict[str, int] = {canon: idx + 1 for canon, idx in wh_hmap.canonical_to_index.items()}
    master_col_1b: Dict[str, int] = {canon: idx + 1 for canon, idx in master_hmap.canonical_to_index.items()}
    ...
    def process_row(r: int) -> Tuple[List[UpdateInstruction], Optional[AppendInstruction]]:
...
def apply_patch_plan(ws, plan: PatchPlan, header_row: int, highlight_date_hex: str, highlight_new_row_hex: str) -> None:
    # 1) Apply updates
